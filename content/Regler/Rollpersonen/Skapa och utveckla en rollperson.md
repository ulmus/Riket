...
1. **Var kommer du ifrån?** Kommer du från pengar eller enklare förhållanden? Norrlands inland eller Stockholms innerstad? Flykting från kriget eller fötterna i svenska myllan sen generationer.
...
4. **Räkna ut sekundära egenskaper:**
    ...
    - **Förflyttning** = slag för *Fysik + Smidighet* för att flytta dig en zon eller mer; normalt Lätt (en zon ingår i turen utan tärning).
