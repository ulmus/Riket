...
- **Räckviddsband:** Bredvid (närstrid) → Nära (samma zon) → Kort (zonen bredvid) → Medel (5 zoner) → Lång (10 zoner) → Mycket lång (så långt sikten räcker). Sikta = ett steg lättare (kräver stillhet); kikarsikte = +1 band
