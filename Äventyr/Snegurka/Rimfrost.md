...
I juli 1962 är Stockholm en stad i sommardvala. Huvudstaden badar i ljus, parkerna blommar och stockholmarna solar på klipporna vid Långholmen. Men under ytan kokar det kalla kriget vidare. T-kontoret, Sveriges hemliga underrättelsetjänst, arbetar dygnet runt med att hålla nationen neutral i en värld som kräver att alla väljer sida.

Sedan hösten 1961 och händelserna i Berlin har Program Frigg utökat sin verksamhet. Doktor Lars Hedström har inte bara fått tillgång till Hans Richters forskning — han har fått ett nytt subjekt: **Anja Morozova**, tolv år gammal, kodnamn **Snegurka**.

### Anja Morozova — Snegurka

Anja Morozova är dotter till **Morana**, den sovjetiska Zvezda-agenten med kryokinetiska krafter som rollpersonerna mötte i Berlin. Anja ärvde sin mammas krafter, men starkare och mer instabila. Redan som spädbarn uppvisade hon förmågor som skrämde de sovjetiska forskarna. Sovjet klassificerade henne som ett vapen under utveckling och placerade henne i Projekt Snegurka — ett isolerat träningsprogram inom Zvezda.
...
**Karin Eklund**, T-kontorets fältkontakt som rollpersonerna känner från Finnmark, var redan då rekryterad av KGB. Eklunds bror har spelskulder som hon inte kan betala och kriminella som hotar honom. KGB erbjöd pengar och skydd, och Eklund accepterade. Det var hon som gav KGB information om Extraktionen och hon har under våren 1962 matat GRU med information om Program Friggs verksamhet — inklusive Anjas placering i R1-hallen.
...
- **Dag 2 (lördag), morgon:** Expressens artikel publiceras
- **Dag 2 (lördag), förmiddag:** Militärpatrull skickas som "stöd"
- **Dag 2 (lördag), eftermiddag:** GRU:s första konfrontation
- **Dag 2 (lördag), kväll:** Ledtrådar om mullvaden
- **Dag 3 (söndag), morgon:** GRU-förstärkning anländer
- **Dag 3 (söndag), förmiddag:** Mullvaden avslöjas
- **Dag 3 (söndag), eftermiddag:** Slutstrid och upplösning
...
*"I natt bröt sig någon in. Utländska operatörer — vi tror GRU. De ville ta henne. Men hon... reagerade. Flydde. Ensam, mitt i natten, genom tunnlarna och ut på Valhallavägen."*

*"Valhallavägens trafikljus frös fast vid halv fyra i morse. Vattenpölar blev till is. I juli. Polisen tror att det är ett kylanläggningsfel. Än så länge."*

Hedström sätter sig tungt.

*"Er uppgift: hitta henne. Innan GRU gör det. Innan polisen gör det. Innan **Expressen** gör det."*

Han pekar mot Eklund.

*"Karin är er kontaktperson. Hon vet vad ni behöver veta om flickan och om R1-hallen. Rapportera till henne."*

**Vad Hedström berättar:**

- Anja har iskrafter — "ni såg dem i Finnmark"
- Hon har varit på KTH sedan dess "för observation och vård"
- GRU har troligen agenter kvar i Stockholm
- Polisen vet ingenting och det ska förbli så
- Anja är tolv år och ensam i Stockholm
...
- **Frost** på väggar, golv och tak. Rimfrost trots juli. Temperaturen under noll.
- **Spruckna vattenledningar** — rören har frusit och spruckit. Smältvatten droppar.
- **GRU:s spår:** skuren larmkabel vid entrén, militärstövelspår, en bortglömd kartskiss över tunnelsystemet, en bedövningspilpistol med två pilar kvar.
- **Forskningsmiljö:** EEG-apparatur, journalmappar, termografiska kameror — i halvcirkel kring Anjas cell.

##### Anjas cell

I hallens ena ände, avskild med en glasvägg och en låst ståldörr, finns en cell. Tre gånger fyra meter. Betongväggar. Ingen utsikt.

**Innehåll:**

- En smal brits med ett tunt lakan
- En trasig tygbjörn (nallen "Misha"), sönderkramad och lagad med medicinsk tejp
...
#### Scen 2: Valhallavägen (frostspår)

Uppe på marknivå. Spåren från natten smälter i sommarsolen men finns kvar i skuggorna.
...
- *Hundägare (man, 65):* "Hunden vägrade passera Humlegården. Frost på gräset."

Spåren leder norrut mot Humlegården men försvinner i morgonsolen.
...
Anja har gömt sig i en **kolonistuga** i **Tantolundens koloniområde** på Södermalm. Området med sina små trädgårdar, bärbuskar och fruktträd påminner henne om familjens **datja** utanför Murmansk — den enda plats där hon var lycklig. I juli står koloniträdgårdarna fulla av jordgubbar, krusbär, ärter och morötter. Anja äter direkt från buskarna och har brutit sig in i en stuga i utkanten av området.

Stugan är liten — ett rum med en bänk, ett bord och en liten spis. Anja har dragit en filt från bänken och sover på golvet med nallen Misha. Hennes köldaura har förvandlat stugan: frost på fönsterrutorna inifrån, is på golvet, rimfrost på taket. Bärbuskarna närmast stugan är frostskadade mitt i sommaren.

**Ledtrådar som pekar hit:**

- Isstigen över Nybroviken (från Scen 2) pekar söderut — mot Södermalm
- En kolonist som kom för att vattna på morgonen: "Jordgubbarna är frusna! Mitt i juli! Och stugan längst ner — det ser ut som vinter därinne"
- Polisrapport om inbrott i en kolonistuga, "inget stulet, men allt var fruset"
- GRU:s kommunikation nämner "koloniområdena" söder om Gamla stan
- Temperaturavvikelse — Tantolunden är flera grader kallare än omgivningen, mätbart med termometer

#### Cliffhanger — Session 1

Rollpersonerna hittar den frostskadade kolonistugan. Fönsterrutorna är vita av is inifrån. Andetag blir synliga. Bärbuskarna runtomkring är svarta och frostbitna.

Bakom dem, på grusgången mellan koloniträdgårdarna: steg. En svart bil parkerar vid Ringvägen. Dörrar öppnas. Röster på ryska.

GRU har hittat dem.

---

### Akt II — "Snöflickan" (Session 2)

Rollpersonerna måste hantera GRU bakom sig och Anja framför sig, sedan bygga förtroende och välja sida.

Möjliga inledningar beroende på cliffhangerns utgång:

- **Strid bland stugorna:** 2 GRU-soldater bland trånga gångar och häckar. Se **Scen 7** för stridsvärden.
- **Flykt med Anja:** Ut genom koloniområdet, över Tantolundens kullar. GRU förföljer.
- **Prismas Diffraktion:** Gömmer gruppen bland stugorna medan GRU passerar.
- **Förhandling:** Vinner tid. Håller inte länge.

#### Scen 5: Kolonistugan — Att hitta Anja

Stugan ser ut som vinter inifrån. Frost på väggarna, is på golvet, rimfrost i taket. Utanför: frostskadade bärbuskar, döda blommor, kall luft.
...
**Motståndsslag:** Rollpersonens Samspel + Vilja mot Anjas Vilja + Vilja (6 tärningar).

| Faktor | Modifiering |
|--------|-------------|
| Silkes feromoner (passiva) | +1 tärning till RP |
| Silkes Manipulation (aktiv) | Lyckad: Anja −2 tärningar |
| Stigmatas Homeostatisk dämpning | Dämpar kraftmanifestationer 1 runda |
| Nämna "mama Katja" (Moranas namn) | Anja −2 tärningar |
| Nämna nallen Misha | +1 tärning till RP |
| Tala ryska | +1 tärning till RP |
| Aggressivt kroppsspråk | −2 tärningar till RP |
| Visa vapen | Anja gör omedelbart rädsla-slag |
...
#### Scen 6: Samtalet med Anja

Anja pratar bruten svenska — lärd under månaderna i R1-hallen, mest från Eklund. Fragmentariskt, med pauser:

*"Mannen med glasögonen... han tog blodet. Varje dag. Och maskinen som piper."* (Schultz EEG-mätningar)

*"De sa att mama hade skickat mig. Men mama hade aldrig skickat mig till ett sådant ställe."*

*"I natt... männen kom. De luktade som hemma. Ryssland. Jag blev rädd. Och då... allting frös."*

Hon frågar:

*"Var är mama?"*

**Rollpersonernas val.** Detta är ett avgörande ögonblick. Rollpersonerna kan:

1. **Berätta sanningen:** Moranas öde är oklart — hon var i Berlin men hennes nuvarande status är okänd. Anja reagerar med sorg men också med beslutsamhet.
2. **Ljuga — "Hon är säker":** Lugnar Anja tillfälligt men skapar en förtroendekris om sanningen kommer fram.
3. **Undvika frågan:** Anja genomskådar det omedelbart och förlorar förtroende.

#### Scen 7: GRU slår till

GRU slår till med full styrka. Zaitsev har fått Anjas position via Eklund och organiserar ett anfall.

**GRU:s taktik:**

- Zaitsev leder personligen. Hans order: ta Anja levande, eliminera svenskarna.
- **Bedövningspilar** mot Anja (sömnmedel — se [[Särskilda situationer#Sömnmedel]], behandla som tiopental: somnar 4+, döende 12, anslag 30 sekunder).
- **Skarp ammunition** mot rollpersonerna.
- GRU attackerar i två grupper: en frontgrupp som binder rollpersonerna och en flankeringsgrupp som försöker nå Anja.

**Platsen** beror på var rollpersonerna befinner sig:

- **Tantolunden:** Koloniområde med trånga gångar, häckar och små stugor. Anjas köldaura gör marken hal. Civila kolonister kan vara i vägen.
- **Humlegården:** Öppen park, civila (komplikation). GRU har siktlinjer.
- **Strandvägen:** Urban strid bland parkerade bilar. Risk för polisinsats.

##### Anjas krafter under strid

Varje runda Anja är i strid eller panik, slå **T12**:
...
Se [[#Kapitan Viktor Zaitsev]] och [[#GRU-soldater]] under Persongalleri.

#### Scen 8: Vart tar vi vägen?

Rollpersonernas val:

- **Tillbaka till T-kontoret?** Hedström vill ha henne. Men rollpersonerna har sett cellen.
- **Gömma henne?** Då jagar både T-kontoret och GRU. Anja behöver vård och mat.
- **Förhandla nya villkor?** Kräver bevis och inflytande.
- **Kontakta polisen/pressen?** Program Friggs existens avslöjas.

#### Cliffhanger — Session 2

Information som delats *bara* med Eklund visar sig känd av GRU. Möjliga avslöjanden:
...
### Akt III — "Rimfrost" (Session 3)

#### Scen 9: Mullvaden avslöjas
...
##### Konfrontation med Eklund

Eklund bryter ihop.

*"Min brors skulder. Hundratusen. Folk som hotar honom. KGB erbjöd sig att betala. Jag visste inte... jag trodde inte..."*

*"Zaitsev har fått ett ultimatum från Moskva: hämta barnet, eller eliminera det."*

**Att bryta Eklund:**

- **Förhör** (*List + Samspel* mot Eklunds *Vilja + Vilja*, 4 tärningar) — avslöjar allt vid framgång
- **Silkes Förslag** — tvingar fram information utan motstånd
- **Empati** (*Samspel + Samspel*) — Eklund berättar frivilligt och erbjuder sig att hjälpa

**Vad Eklund vet:**

- Zaitsevs styrkor och position (3 soldater + eventuellt Polaris)
- GRU:s kommunikationsfrekvenser
- Sista anfallet planeras "innan söndag kväll"
- Hennes KGB-kontakt lovade att Anja inte skulle skadas — hon tror inte på det längre

#### Scen 10: GRU:s sista framstöt

Zaitsev samlar allt för ett sista anfall.

##### GRU:s styrkor

- **Kapitan Zaitsev** — leder personligen
- **3 GRU-soldater** — automatvapen och bedövningspilar
- **Polaris** (valfri eskalering) — Zvezda-agent, magnetkrafter. Svag mot Radars Pulsstörare.

##### Platsen

**Skeppsholmen:** Isolerad ö, bro som enda väg. Lätt att blockera och försvara. Vatten som Anja kan frysa.

**Djurgården:** Öppen mark, civila. GRU vill undvika vittnen men tvekar inte.

**Tantolunden:** Tillbaka vid koloniområdet. Trånga gångar, häckar som siktskydd, stugor som skydd. Anjas köldaura fryser trädgårdarna.

##### Stridsdynamik

**Fas 1 — Avskärning:** GRU-soldaterna blockerar flyktvägar. Zaitsev dirigerar.

**Fas 2 — Gripande:** Zaitsev eller soldat försöker nå Anja med bedövningspilar. Polaris (om med) drar bort vapen med magnetkraft.

**RP:s fördelar:**

- Vet att anfallet kommer (via Eklund)
- Kan välja plats och förbereda sig
- Anja kan vara en allierad (se Scen 11)
- Radars Pulsstörare slår ut Polaris och GRU:s radio

#### Scen 11: Anjas val

Om rollpersonerna är i fara kan Anja välja att använda sina krafter aktivt och medvetet för första gången.
...
**1. Tillbaka till Program Frigg, men på nya villkor.** Inga fler experiment, ordentlig bostad, skolgång, regelbundna besök av RP. Anja får det inte bra — men bättre.

**2. Anja försvinner.** Ny identitet, fosterfamilj utanför T-kontorets räckvidd. Prisma förfalskar dokument, Silke arrangerar kontakter. GRU slutar aldrig leta.

**3. Överlämnas till tredje part.** USA? Frankrike? Politiskt riskabelt. Anja byter ett program mot ett annat.

**4. Anja väljer själv.** Första gången en vuxen frågar vad *hon* vill.
...
Tolv år. Tunn, blek, mörkt smutsigt hår, stora bruna ögon. Tunt sjukhuslinne, bara fötter. Alltid en svag köldzon runt henne.

Rädd och misstänksam men med barnlig längtan efter trygghet. Krafterna är försvarsreaktion, inte attack.

**Språk:** Ryska (modersmål), bruten svenska.
**Motivation:** Överleva. Hitta mamma. Sluta vara rädd.

**Egenskaper:**

| Egenskap | Värde | Sekundärt | |
|:---------|------:|:----------|:------|
| Analys | 2 | KP | 4 |
| Fysik | 1 | Sårad | > 1 KP |
...
**Trauma:** Förlust (mamma, frihet, barndom)

**Beteende vid aktiverat trauma:** *Desperat beskyddare* — Anja omsluter den närmaste personen med okontrollerbar kyla, "skyddar" dem i is oavsett om de vill eller ej.

##### Anjas krafter

Anjas krafter följer Frostbrand-mallen från [[Krafter#Frostbrand – Kryokinesi]] men är starkare och mer instabila. Hon har ingen träning och liten kontroll.
...
Anjas passiva köldaura varierar med hennes stressnivå:
...
Hedströms ställföreträdare. Fyrtio år, smalt ansikte, stålbågade glasögon, vit labbrock. Talar långsamt och precist.

Kall och metodisk. Ser Anja som "Subjekt S", inte som ett barn. Inte sadist — bara likgiltig.

**Motivation:** Skydda forskning och karriär. Få tillbaka Anja.

**Roll i äventyret:** Dyker upp om rollpersonerna konfronterar T-kontoret. Rationaliserar: *"Allt gjordes under kontrollerade former."* En Hedström utan skuldkänslor.
...
Redan etablerad. Förrädare av desperation, inte övertygelse.

Under ytan: ångestfylld, sömnlös, skuldtyngd. Dricker för mycket kaffe, undviker ögonkontakt, kontrollerar sin radio för ofta.

**Motivation:** Skydda sin bror. Betala skulden. Överleva.

**Ledtrådar SL kan plantera:**

- Eklund frågar specifikt var rollpersonerna planerar att söka härnäst (samlar info)
...
**Expertis:** Fältagent
**Utrustning:** Pistol m/40, modifierad radio med KGB-krypteringsmodul, kodbok (gömd i fodersfickan på jackan), anteckningsblock.

### GRU

#### Kapitan Viktor Zaitsev

Fyrtio år, atletisk, ärr från vänster öga till hakan. Korthugget grått hår. Talar grundläggande svenska med stark accent.

Soldat med order, inte monster. Respekterar fiender, undviker onödig brutalitet, tvekar inte att döda. Har en dotter i Anjas ålder — visar det aldrig.

**Motivation:** Hämta Anja levande. Komma hem.
...
**Expertis:** Soldat, Officer
**Förmågor:** Taktik, Kalla nerven

**Utrustning:**

- **Stechkin APS (automatpistol):** Räckvidd 30 m, skadetärningar +4, kritisk bonus +0, skadetyp Småkaliber, Automateld. Ammunition ❏❏❏
...
Civilklädda operatörer, 25–30 år, militär hållning. Talar inte svenska.
...
- **AK-47 (gömd i resväska):** Räckvidd 60 m, skadetärningar +5, kritisk bonus +0, skadetyp Storkaliber, Automateld. Ammunition ❏❏❏
- **Makarov PM:** Räckvidd 25 m, skadetärningar +4, kritisk bonus +0, skadetyp Småkaliber. Ammunition ❏❏
- Kniv, radio

#### Polaris (valfri Zvezda-agent)

Förstärkning om Zaitsev misslyckas. Trettiofem år, blek, tunnhårig, intensiv blick. Bär alltid handskar (metallspån under naglarna). Tyst, fokuserad, föraktar Zaitsevs grova metoder.

**Motivation:** Bevisa Zvezdas överlägsenhet.
...
Expressen, trettio år, envis. Kan bli problem eller tillgång. Hanteras han inte publicerar han successivt mer alarmerande artiklar. Tas han till RP:s sida kan han vara allierad mot T-kontoret.

**Motivation:** Story. Karriär. Pressfrihet.

**Egenskaper:** Analys 3, Samspel 3, Sinnen 2, List 2, Vilja 2, Fysik 1, Smidighet 1, Strid 1.

#### Thede Palm — T-kontorets chef

Femtio år, militär hållning. Pragmatisk byråkrat, ser Frigg som nödvändigt ont.

**Motivation:** Ordning. Kontroll. Minimera skador.

Kan kontaktas direkt om rollpersonerna vill gå över Hedströms huvud. Med bevis på mullvad eller experiment agerar han — men hans "agera" kan innebära att stänga ner *allt*, inklusive rollpersonernas operativa frihet.

**Egenskaper:** Analys 3, Samspel 3, Vilja 4, Sinnen 2, List 2, Fysik 2, Smidighet 1, Strid 2.
...
Börjar lojala, pressas mot revolt. Varje avslöjande driver dem längre från arbetsgivaren. I slutet: institutionen eller barnet.

### T-kontoret

T-kontoret är inte ondskefullt — det är byråkratiskt och moraliskt elastiskt. Det gör det värre.

**Eskalering:**

1. **Dag 1:** Meddelanden via Eklund — "Rapportera er position"
2. **Dag 2:** Direkta krav från Hedström — "Lämna flickan till oss"
3. **Dag 2, kväll:** Hot från Palm — "Ni opererar utanför ert mandat"
4. **Dag 3:** Militärpatrull skickas för att "stödja" rollpersonerna (i verkligheten för att ta kontroll)
5. **Dag 3:** Om rollpersonerna vägrar — arresteringsorder

### GRU

Yttre hot. Alltid ett steg bredvid tack vare mullvaden, tills hon avslöjas.

**Eskalering:**

1. **Dag 1:** Spaning, observation, inga direkta konflikter
2. **Dag 2:** Första konfrontationen — försöker ta Anja med bedövningspilar
3. **Dag 3:** Full insats — dödlig kraft, inga hänsyn

### Informationstabell

| Tidpunkt | RP vet | T-kontoret vet | GRU vet |
|----------|--------|----------------|---------|
| **Prolog** | Anja borta, GRU-intrång, uppdrag att hitta henne | Allt ovan + experimenten + mullvadens existens (dold) | Anjas plats (via Eklund), RP:s uppdrag |
| **Akt I** | Experimenten (via R1), Anjas gömställe | RP:s position (via Eklund), GRU:s närvaro | RP:s sökområde (via Eklund), Anjas ungefärliga position |
| **Akt II** | Anja i säkerhet (tillfälligt), GRU:s styrka | RP:s beslut om Anja (via Eklund?) | RP:s position (via Eklund), Anjas plats |
| **Akt III** | Mullvaden avslöjad, GRU:s slutplan | Mullvaden avslöjad (om RP berättar) | Förlorar informationsövertag |
...
Behandla som **kapplöpning** (se [[Aktiviteter#Kapplöpning]]):
...
Tre metoder — se [[#Scen 9 Mullvaden avslöjas]]. En räcker.

### Stridsscener

- GRU: skarpt mot RP, **bedövningspilar** mot Anja
- Anjas krafter = **miljöeffekt** — se paniktabell under [[#Scen 7 GRU slår till]]
- Polaris svag mot Radars Pulsstörare (medveten design: Radar-spotlight)

### Köldskada

Slås på tabellen **Övriga** under [[Kritiska träffar#Övriga]].

---

## Emotionella beats (checklista)

Minst fyra av sju bör spelas ut:

1. **Anjas cell i R1-hallen** — nallen, böckerna, inga fönster. Moralisk chock.
2. **Att hitta Anja** — smutsig, rädd, ensam, frost runt henne. Empati.
3. **"Var är mama?"** — Rollpersonerna måste välja vad de säger. Sanning eller lögn.
4. **Anjas första leende** — när hon äntligen litar på någon. Isen smälter bokstavligt.
5. **Anja ser KTH** (om de passerar i närheten) — ren skräck, kraftexplosion. Trauma.
6. **"Ni ska inte skada dem"** — Anja skyddar rollpersonerna. Barnet krigar.
7. **Anjas val** — första gången en vuxen frågar vad hon vill. Respekt.

---

## RP-specifika spotlight-moment
...
- **Feromoner** lugnar Anja under första mötet — passiv men avgörande.
- **Manipulation** kan styra GRU-soldaters moral under strid.
- **Förslag** bryter Eklund vid konfrontationen — snabb och effektiv metod.
- Sociala scener med Hedström, Palm och Lindblad — Silke är gruppens ansikte utåt.

### Tjuren

- Fysisk konfrontation med GRU — Tjuren mot Zaitsev i närstrid.
- **Tjurrusning** genom GRU:s barrikader eller genom tunnelns betongväggar.
- Delad måltid med Anja — sardiner. En enkel handling som bygger förtroende.
- Bär Anja om hon inte kan gå. Beskyddarinstinkten.
...
- **Cytokinetisk överföring** läker Anjas småskador och köldskadade fötter.
- **Homeostatisk dämpning** kontrollerar Anjas krafter tillfälligt — dämpar utbrottet.
- "Jag vet hur det känns att vara annorlunda" — delad upplevelse av att vara ett experiment.
- Medicinsk expertis identifierar spåren av Schultz experiment.

---

## Komplikationer (branching)

| Händelse | Konsekvens |
|----------|-----------|
| RP ger Anja till T-kontoret | GRU bryter in igen (via Eklund). Slutstrid i R1-hallen. |
| RP kontaktar polisen | Panik, medieläcka. T-kontoret: arresteringsorder, mörkläggning. |
| RP försöker lämna Stockholm | Militärpolis blockerar Arlanda och utfarter. |
| Anja dödar någon | Sammanbrott → fryspelare. RP måste bryta igenom isen. |
| Zaitsev dödas tidigt | GRU skickar Polaris — farligare, oberäkneligare. |
| Eklund avslöjas tidigt | GRU förlorar informationsövertag, agerar desperat. Eklund kan bli allierad. |
| RP kontaktar Palm direkt | Palm tar ärendet från Hedström. Kan ge frihet eller stänga ner allt. |
