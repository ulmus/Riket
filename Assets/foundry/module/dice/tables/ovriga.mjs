...
export const OVRIGA = [
  ...
  { min: 11, max: 11, label: "Svår intern skada", effect: "Alla slag är minst Mycket Svåra. Döende." },
  { min: 12, max: 12, label: "Svår systemisk skada", effect: "Akut döende. Om du överlever: Permanent –1 på Fysik." },
  { min: 13, max: 13, label: "Kritisk organsvikt", effect: "Akut döende." },
  { min: 14, max: 14, label: "Total systemkollaps", effect: "Akut döende. Om du överlever: Permanent –2 på Fysik och Vilja." },
