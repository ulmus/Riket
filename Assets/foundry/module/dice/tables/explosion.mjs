...
export const EXPLOSION = [
  ...
  { min: 11, max: 11, label: "Krossade revben – intern skada", effect: "Fysik-slag är minst Mycket Svåra. Kraftig blödning. Döende: Överlevnadsslag per timme." },
  { min: 12, max: 12, label: "Massiv intern skada", effect: "Inre organ krossade av tryckvågen. Döende: Överlevnadsslag per minut. Om du överlever: Permanent –2 på Fysik, permanent hörselskada." },
  { min: 13, max: 13, label: "Arm/ben avslivet", effect: "Slå 1T12 för kroppsdel (1-6: ben, 7-12: arm), sedan udda/jämnt för sida. Kraftig blödning. Döende: Överlevnadsslag per runda. Permanent: Amputation." },
  { min: 14, max: 14, label: "Bortsprängd bröstorg", effect: "Döende: Överlevnadsslag per runda. Om du överlever: Permanent –4 på Fysik." },
