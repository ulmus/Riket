...
export const BLODNING = [
  ...
  { min: 11, max: 11, label: "Svår hypovolemisk chock", effect: "Döende: Överlevnadsslag per minut." },
  { min: 12, max: 12, label: "Organsvikt", effect: "Döende: Överlevnadsslag per minut. Permanent: –1 på Fysik." },
  { min: 13, max: 13, label: "Hjärtstillestånd", effect: "Döende: Överlevnadsslag per runda (kräver hjärt-lungräddning för att stabiliseras)." },
  { min: 14, max: 14, label: "Total cirkulationskollaps", effect: "Döende: Överlevnadsslag per runda. Om du överlever: Permanent –2 på Fysik och Vilja (hjärnskada)." },
