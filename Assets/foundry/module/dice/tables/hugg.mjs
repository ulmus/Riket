...
export const HUGG = [
  ...
  { min: 11, max: 11, label: "Djupt brösthugg med organskada", effect: "Kraftig blödning. Alla slag är minst Mycket Svåra. Döende." },
  { min: 12, max: 12, label: "Ben avhugget", effect: "Slå 1T12: 1-6 vänster, 7-12 höger ben. Du faller. Kan inte gå. Kraftig blödning. Akut döende. Permanent: Amputation." },
  { min: 13, max: 13, label: "Arm avhuggen", effect: "Slå 1T12: 1-6 vänster, 7-12 höger arm. Kraftig blödning. Akut döende. Permanent: Amputation." },
  { min: 14, max: 14, label: "Klyvning av bröstkorgen", effect: "Inre organ skärs sönder. Akut döende. Om du överlever: Permanent –3 på Fysik." },
