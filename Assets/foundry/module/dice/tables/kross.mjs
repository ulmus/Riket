...
export const KROSS = [
  ...
  { min: 2, max: 2, label: "Andan slagen ur dig", effect: "Du tappar andan. Förlorar din nästa bihandling." },
  ...
  { min: 9, max: 9, label: "Brutet ben", effect: "Slå 1T12: 1-6 vänster, 7-12 höger ben. Du faller omkull. Du kan inte gå eller springa, endast krypa (bihandling för 1 meter). Behandlas med Kirurgi. Läketid: 1T12 veckor." },
