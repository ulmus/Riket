...
export const STICK = [
  ...
  { min: 11, max: 11, label: "Stucken i magen", effect: "Kraftig blödning. Fysik-slag är minst Svåra. Döende om obehandlad. Behandlas med Kirurgi (Svårt)." },
  { min: 12, max: 12, label: "Artärblödning", effect: "Kraftig blödning. Akut döende tills blödningen stoppas (Kirurgi)." },
  { min: 13, max: 13, label: "Genomstucket hjärtsäck", effect: "Akut döende. Behandlas med Kirurgi (Mycket Svårt). Om du överlever: Permanent –1 på Fysik." },
  { min: 14, max: 14, label: "Genomstucken halspulsåder", effect: "Kraftig blödning. Akut döende. Behandlas med Kirurgi (Mycket Svårt). Om du överlever: Permanent –2 på Fysik och Analys (hjärnskada)." },
