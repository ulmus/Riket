...
| **3+**  | Ultimat förmåga, i allmänhet en gång per scen |

### Fokus-generering

- **12 på tärning** → 1 Fokus
- **Förmågor** → Lagarbete: 1 Fokus när du hjälper och lyckas
...
| **Två saker samtidigt**    | Ett steg svårare, eller 1 Fokus  | Röra dig + sikta, attackera två mål, köra + skjuta    |
...
S: Du har en handling plus en kort förflyttning per runda. Vill du göra två saker som kräver din uppmärksamhet (t.ex. röra dig och sikta, eller attackera två mål) blir det ett steg svårare — eller spendera 1 Fokus för att slippa avdraget.
...
S: Av SL vid nedtid (träning) eller kampanj-milstolpar. Rekommenderat: 1 per 3-5 sessioner.
