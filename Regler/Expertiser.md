...
Under normala, ostressade förhållanden – utan tidspress, hotfulla motståndare eller andra komplikationer – kan en karaktär med relevant Expertis utföra vissa aktiviteter utan att slå. Dessa räknas som att de har **1 framgång**, men genererar aldrig Fokus.

Automatisk framgång gäller endast när:

- Karaktären har relevant Expertis.
- Det finns tillräckligt med tid för uppgiften.
- Ingen yttre press eller fara föreligger.
- Uppgiften är inom ramarna för vad expertisen normalt hanterar.

Så snart situationen blir stressad – en vakt närmar sig, klockan tickar, eller något oförutsett händer – krävs ett slag som vanligt.

Varje Expertis listar nedan exempel på aktiviteter som kan utföras med automatisk framgång.
...
- **Automatisk framgång:** Identifiera vanliga läkemedel, dosera standardmedicin, känna igen tecken på förgiftning, tillverka enkla salvor eller bedövningsmedel med rätt ingredienser.
...
- **Bonus på aktiviteter:** Analys + Analys vid dekryptering och kodanalys.
...
- **Automatisk framgång:** Använda kodbok korrekt, kryptera och dekryptera meddelanden med känd nyckel, identifiera vanliga krypteringsmetoder, upprätta enkel kodrutin för gruppen.
...
- **Bonus på aktiviteter:** Analys + Analys när du laddar eller riggar spräng (riktverkan, säkringar).
...
- **Automatisk framgång:** Identifiera sprängämnestyper, avgöra om en laddning är stabil, förbereda standardladdning för sprängning, desarmera enkel stubin eller synlig tändare.
...
- **Automatisk framgång:** Genomföra rutinmässigt förhör med samarbetsvillig person, bygga grundläggande rapport, identifiera uppenbara lögner eller nervositet, planera förhörsstrategi.
...
- **Bonus på aktiviteter:** Smidighet + Smidighet i biljakt och undanmanöver.
