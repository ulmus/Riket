...
Varje expertis sänker svårigheten ett steg på relevanta aktiviteter och öppnar upp specialförmågor. Aktiviteter som kräver expertisen blir Svåra eller Mycket Svåra om du försöker utan den. Förmågor som kräver expertis beskrivs i [[Förmågor#Expertisförmågor]].
...
Är situationen pressad kan SL sätta en högre grundsvårighet: en uppgift som är **Svår** under tidspress blir **Normal** med expertis och kräver fortfarande ett slag.

Varje Expertis listar nedan exempel på aktiviteter som är Lätta för karaktären.

## Läkare

- **Sänker svårigheten för:** Analys + Smidighet för Akutvård i fält. Analys + Sinnen för diagnosticering och behandling.
...
- **Sänker svårigheten för:** Analys + Smidighet för akutvård och stabilisering i fält.
...
- **Sänker svårigheten för:** Analys + Analys för att identifiera, dosera eller framställa läkemedel och enkla antidoter.
- **Kräver expertisen:** Aktiv vård/medicin (Analys + Analys) när det handlar om doser och blandningar.
- **Förmågor som kräver expertisen:** [[Förmågor#Precisionsdos]], [[Förmågor#Snabbverkande]].
...
- **Sänker svårigheten för:** Analys + Smidighet när du riggar radio/antenn eller stabiliserar förbindelse.
...
- **Lätt:** Ställa in frekvenser, rigga enkel antenn, utföra rutinunderhåll på radioutrustning, avgöra om en radiosändare fungerar.

## Telegrafist

- **Sänker svårigheten för:** Sinnen + Vilja eller Analys + Sinnen när du lyssnar i brus/störningar (morse, signalspaning).
...
- **Lätt:** Sända och ta emot morse under goda förhållanden, identifiera standardsignaler, logga trafik, avgöra signalstyrka och riktning med rätt utrustning.

## Kryptograf

- **Sänker svårigheten för:** Analys + Analys vid dekryptering och kodanalys.
- **Kräver expertisen:** Bryta komplex kryptering (Analys + Analys), sätta upp säkra kodsystem i fält.
- **Förmågor som kräver expertisen:** [[Förmågor#Kodknäckare]], [[Förmågor#Mönsteröga]].
...
- **Sänker svårigheten för:** Analys + List för förfalskningar (pass, stämplar, patina).
...
- **Lätt:** Identifiera äkta dokument från uppenbara förfalskningar, kopiera enkla stämplar, åldra papper på ett trovärdigt sätt, avgöra vilka säkerhetsdetaljer ett dokument har.

## Låssmed

- **Sänker svårigheten för:** List + Smidighet för att dyrka eller koppla förbi lås och enkla larm.
...
- **Sänker svårigheten för:** Analys + Analys när du laddar eller riggar spräng (riktverkan, säkringar).
- **Kräver expertisen:** Ladda sprängämne för kontrollerad riktverkan (Analys + Analys).
- **Förmågor som kräver expertisen:** [[Förmågor#Kontrollerad sprängning]], [[Förmågor#Riktad laddning]].
...
- **Sänker svårigheten för:** Analys + Smidighet för fältreparation av fordon eller maskin.
...
- **Lätt:** Utföra rutinunderhåll på fordon, byta däck eller tändstift, diagnostisera enkla motorproblem, avgöra om ett fordon är körbart.

## Elektriker

- **Sänker svårigheten för:** Analys + Analys för sensorer, larm och enkla kretsar.
...
- **Sänker svårigheten för:** List + Samspel för förklädnad, täckhistoria och kroppsspråk i infiltration.
...
- **Lätt:** Applicera grundläggande smink, förändra utseende med peruker och kläder, bygga enkel täckhistoria, avgöra om någon annan bär förklädnad.

## Förhörsledare

- **Sänker svårigheten för:** List + Samspel vid taktiska förhör (rapportbyggande, frågeteknik).
- **Kräver expertisen:** Förhöra taktiskt (List + Samspel) i känsliga eller farliga situationer.
- **Förmågor som kräver expertisen:** [[Förmågor#Press]], [[Förmågor#Psykologisk insikt]].
...
- **Sänker svårigheten för:** Samspel + Strid när du leder i pågående strid (ordrar, elddisciplin).
...
- **Sänker svårigheten för:** Smidighet + Smidighet i biljakt och undanmanöver.
...
- **Sänker svårigheten för:** Smidighet + Smidighet för flygning, landning och flygmanövrar.
...
- **Sänker svårigheten för:** Analys + Analys eller Analys + Sinnen när du bygger lägesbild och källvärdering.
...
- **Sänker svårigheten för:** Analys + Sinnen för att upptäcka intrång, läckor och fällor.
