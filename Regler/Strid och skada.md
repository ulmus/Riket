...
| ------------------------------------- | -------------------- |
| Mindre än vuxen människa (hund, barn) | **+1**               |
| Vuxen människa                        | **0**                |
| Större (häst, lätt fordon)            | **−1**               |
| Mycket större (tungt fordon)          | **−2**               |
...
> **Anton** skjuter med sin revolver mot en sovjetisk gränsvakt. Revolvern har bas-skadetröskel **8+**. Vakten bär **tjock rock (skydd 1)** → tröskel **9+**.  
> Det är en beväpnad attack mot en människa → **3 tärningar**. Antons träffslag får **1 extra framgång**, som han byter mot **+1 skadetärning** → **4 skadetärningar**.  
...
2. Räkna **slutlig skadetröskel** (vapen ± slagstyrka/effekter + skydd).
