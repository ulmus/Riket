Stress och rädsla är en viktig del av I Rikets Tjänst. Sin träning till trots så är våra hjältar bara människor och människor blir rädda.
# Stabilitet
...
När något skrämmande eller chockartat inträffar: **slå Närvaro + lämplig egenskap**.  
...
|   **8** | **Panik**             | Du **flyr** mot närmaste skydd eller bort från hotet **i en runda** och **släpper** allt du håller i. Alla i närheten gör ett **Rädsla-slag (Närvaro + Närvaro)**.          |
|   **9** | **Raseri**            | Du tappar kontrollen och **attackerar närmaste hot/person** (vän eller fiende) **i en runda**. Alla i närheten gör **Rädsla-slag (Närvaro + Närvaro, svårighet –1)**.       |
...
|      Slag | Trauma                    | Effekt                                                                                                                                                                 |
| --------: | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   **1–2** | **Fobi**                  | Irrationell rädsla kopplad till händelsen (t.ex. blod, mörker, trånga utrymmen, eld, höga ljud). När du konfronteras: **omedelbart Rädsla-slag** med **svårighet –1**. |
|   **3–4** | **Paranoia**              | Du misstänker andras motiv. **–1 på Närvaro** i känsliga lägen, men **+1** för att upptäcka **lögn/svek**.                                                             |
|   **5–6** | **Aggressionsproblem**    | Du reagerar ofta med vrede. Vid misslyckat Rädsla-slag kan du **välja Raseri** i stället för att markera Stress.                                                       |
|   **7–8** | **Avtrubbning**           | Du stänger av känslor. **+1 på Rädsla-slag** mot död/våld, men **–1 på Närvaro** i scener som kräver empati.                                                           |
|  **9–10** | **Posttraumatisk stress** | Din Stress kan inte sänkas under **1** utan **lång vila** eller **terapeutisk hjälp**.                                                                                 |
| **11-12** | **Beroende**              | Du utvecklar ett beroende (alkohol, tabletter, ritual, relation). Om du inte kan tillfredsställa det i en scen: **+1 Stress**.                                         |
...
- **Stressreducerande handling** (RP-specifik): ta bort **Närvaro** rutor.
